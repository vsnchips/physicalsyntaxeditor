...
nmap <buffer> <nowait>  <Plug>(vimfiler_print_filename)
nmap <buffer> 	 <Plug>(vimfiler_switch_to_other_window)
nmap <buffer> <nowait>  <Plug>(vimfiler_cd_or_edit)
nmap <buffer>  <Plug>(vimfiler_redraw_screen)
nmap <buffer> <nowait>  <Plug>(vimfiler_switch_vim_buffer_mode)
...
nmap <buffer> <nowait> X <Plug>(vimfiler_execute_vimfiler_associated)
...
nmap <buffer> <nowait> g <Plug>(vimfiler_toggle_maximize_window)
nmap <buffer> <nowait> go <Plug>(vimfiler_open_file_in_another_vimfiler)
nmap <buffer> <nowait> g? <Plug>(vimfiler_help)
nmap <buffer> <nowait> ge <Plug>(vimfiler_execute_external_filer)
...
nnoremap <buffer> <silent> <expr> st vimfiler#do_action('tabswitch')
nmap <buffer> <nowait> t <Plug>(vimfiler_expand_tree)
nmap <buffer> v <Plug>(vimfiler_quick_look)
nmap <buffer> <nowait> x <Plug>(vimfiler_execute_system_associated)
...
nmap <buffer> <nowait> <2-LeftMouse> <Plug>(vimfiler_double_click)
nmap <buffer> <nowait> <RightMouse> <Plug>(vimfiler_execute_external_filer)
nmap <buffer> <nowait> <BS> <Plug>(vimfiler_switch_to_parent_directory)
nmap <buffer> <nowait> <S-Space> <Plug>(vimfiler_toggle_mark_current_line_up)
nmap <buffer> <nowait> <S-LeftMouse> <Plug>(vimfiler_toggle_mark_current_line)
nnoremap <buffer> <silent> <expr> <Plug>(vimfiler_cursor_top) (vimfiler#get_file_offset(b:vimfiler)+1).'Gzb'
nmap <buffer> <silent> <Plug>(vimfiler_smart_l) <Plug>(vimfiler_expand_or_edit)
nnoremap <buffer> <silent> <Plug>(vimfiler_cd_vim_current_dir) :call vimfiler#mappings#_change_vim_current_dir()
nmap <buffer> <Plug>(vimfiler_cd) <Plug>(vimfiler_cd_vim_current_dir)
nnoremap <buffer> <silent> <Plug>(vimfiler_preview_file) :call vimfiler#mappings#do_action(  b:vimfiler, b:vimfiler.context.preview_action)
nnoremap <buffer> <silent> <Plug>(vimfiler_hide) :call vimfiler#util#hide_buffer()
nnoremap <buffer> <silent> <Plug>(vimfiler_edit_file) :call vimfiler#mappings#do_switch_action(   b:vimfiler, b:vimfiler.context.edit_action)
nmap <buffer> <silent> <Plug>(vimfiler_toggle_visible_dot_files) <Plug>(vimfiler_toggle_visible_ignore_files)
nnoremap <buffer> <silent> <Plug>(vimfiler_switch_to_project_directory) :call vimfiler#mappings#cd_project()
nnoremap <buffer> <silent> <Plug>(vimfiler_switch_to_root_directory) :call vimfiler#mappings#cd('file:/')
nnoremap <buffer> <silent> <Plug>(vimfiler_switch_to_home_directory) :call vimfiler#mappings#cd('file:~')
nnoremap <buffer> <silent> <Plug>(vimfiler_switch_to_parent_directory) :call vimfiler#mappings#cd('..')
nmap <buffer> <silent> <expr> <Plug>(vimfiler_expand_or_edit) vimfiler#mappings#smart_cursor_map(  "\<Plug>(vimfiler_expand_tree)",  "\<Plug>(vimfiler_edit_file)")
nmap <buffer> <silent> <expr> <Plug>(vimfiler_cd_or_edit) vimfiler#mappings#smart_cursor_map(  "\<Plug>(vimfiler_cd_file)",  "\<Plug>(vimfiler_edit_file)")
nnoremap <buffer> <silent> <Plug>(vimfiler_redraw_screen) :call vimfiler#force_redraw_screen(1)
nnoremap <buffer> <expr> <Plug>(vimfiler_loop_cursor_down) (line('.') == line('$'))?  (vimfiler#get_file_offset(b:vimfiler)+1).'Gzb' : 'j'
...
setlocal statusline=%#SpaceVim_statusline_ia#%{SpaceVim#layers#core#statusline#mode(mode())}\ %{\ SpaceVim#layers#core#statusline#winnr(get(w:,\ \"winid\",\ winnr()))\ }\ %#SpaceVim_statusline_ia_SpaceVim_statusline_b#%#SpaceVim_statusline_b#\ vimfiler\ %#SpaceVim_statusline_b_SpaceVim_statusline_c#\ 
setlocal suffixesadd=
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != 'vimfiler'
setlocal syntax=vimfiler
endif
setlocal tabstop=2
setlocal tagcase=
setlocal tags=
...
setlocal spellfile=
setlocal spelllang=en
setlocal statusline=%#SpaceVim_statusline_a#%{SpaceVim#layers#core#statusline#mode(mode())}\ %{\ SpaceVim#layers#core#statusline#winnr(get(w:,\ \"winid\",\ winnr()))\ }\ %#SpaceVim_statusline_a_SpaceVim_statusline_b#%#SpaceVim_statusline_b#%{\ &modified\ ?\ '\ *\ '\ :\ '\ -\ '}editor_core.js\ %#SpaceVim_statusline_b_SpaceVim_statusline_c#%#SpaceVim_statusline_c#%{empty(&ft)?\ \"\"\ :\ \"\ \"\ .\ &ft\ .\ \"\ \"}%#SpaceVim_statusline_c_SpaceVim_statusline_b#%#SpaceVim_statusline_b#\ ❖\ ⓢ\ \ %#SpaceVim_statusline_b_SpaceVim_statusline_c#%#SpaceVim_statusline_b_SpaceVim_statusline_z#%#SpaceVim_statusline_z#%=%#SpaceVim_statusline_z#%{SpaceVim#layers#core#statusline#_current_tag()}%#SpaceVim_statusline_b_SpaceVim_statusline_z#%#SpaceVim_statusline_b#%{\"\ \"\ .\ g:_spacevim_statusline_fileformat\ .\ \"\ |\ \"\ .\ (&fenc!=\"\"?&fenc:&enc)\ .\ \"\ \"}%#SpaceVim_statusline_c_SpaceVim_statusline_b#%#SpaceVim_statusline_c#\ %P\ %#SpaceVim_statusline_b_SpaceVim_statusline_c#
setlocal suffixesadd=
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != 'javascript'
...
setlocal spellfile=
setlocal spelllang=en
setlocal statusline=%#SpaceVim_statusline_ia#%{SpaceVim#layers#core#statusline#mode(mode())}\ %{\ SpaceVim#layers#core#statusline#winnr(get(w:,\ \"winid\",\ winnr()))\ }\ %#SpaceVim_statusline_ia_SpaceVim_statusline_b#%#SpaceVim_statusline_b#%{\ get(w:,\ \"winwidth\",\ 150)\ <\ 38\ ?\ \"\"\ :\ (\"\ 222\ bytes\ index.html\ \ \")}%{\ get(w:,\ \"winwidth\",\ 150)\ <\ 47\ ?\ \"\"\ :\ (\"\ \ html\ \")}%{\ get(w:,\ \"winwidth\",\ 150)\ <\ 61\ ?\ \"\"\ :\ (\"\ \ ❖\ ⓢ\ \ \ \")}%=%{\"\ \"\ .\ &ff\ .\ \"|\"\ .\ (&fenc!=\"\"?&fenc:&enc)\ .\ \"\ \"}\ %P\ 
setlocal suffixesadd=
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != 'html'
...
badd +2 proof-of-concept/editor/editor_core.js
